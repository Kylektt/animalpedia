...
- The 3D prototype is a buildless static site in `dist/` using a vendored model-viewer module. Preserve this setup. The teammate plans to integrate with Next.js; maintain the copy-in adapter under `integrations/nextjs/` without migrating this sandbox to a framework.
